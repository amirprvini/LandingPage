...
const NavBar: React.FC<navBarProps> = () : JSX.Element => {
  return <div className="navBar bg-black text-white flex justify-between items-center border-b-2 border-gray-300 h-14 px-2 font-Poppins">
        
        <div className="logoWrapper flex space-x-4">
            <div className="logoIconWrapper">
                <img src="./my-app/images/logo.png" alt="headerLogo" />
            </div>
